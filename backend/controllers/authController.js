...
exports.signup = async (req, res) => {
  try {
    ...
    const newUser = await User.create({
      ...
      password: req.body.password, // This will be hashed automatically by the pre-save hook
      passwordConfirm: req.body.passwordConfirm, // Will be removed by the pre-save hook
